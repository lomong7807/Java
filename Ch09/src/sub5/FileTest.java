...
public class FileTest {
	public static void main(String[] args) {
		...
		File f2 = new File("../../../../../file2");	//확장자 없는건 파일이 아닌 폴더
		//다섯번 바깥으로 나온 폴더
		...
		try {
			...
			// 파일 구분 확인
			System.out.println("f1 isFile : "+ f1.isFile());		// is나 has로 돼있는 명령어는 boolean
			...
			System.out.println("f1 getAbsolutePath : "+ f1.getAbsolutePath());	// 절대경로(시스템상의 위치)
