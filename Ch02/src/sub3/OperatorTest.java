...
public class OperatorTest {
	public static void main(String[] args) {
		...
		int result5 = num4 % num3; //나머지 연산자 4에서 3을 나눠서 남는 1
		int result6 = num4 % num2; //4에서 2를 나눠서 남는게 0
		int result7 = num4 % 5; // 4에서 5를 나눠서 남는게 4
		...
		n1 += 1;  // n1 = n1 + 1  기존값과 더하기
		n2 -= 2;  // n2 = n2 - 2  기존값에서 빼기
		n3 *= 3;  // n3 = n3 * 3
		n4 /= 4;  // n4 = n4 / 4
		...
		boolean res1 = (var3 > 3) && (var4 > 3); // and - 둘 다 true여야지 전체가 true
		boolean res2 = (var3 > 2) && (var4 > 3); // true
		boolean res3 = (var3 > 3) || (var4 > 3); // or - 둘 다 false여야지 전체가 false
		boolean res4 = (var3 > 3) || (var4 > 5);
		boolean res5 = !(var3 > var4); // ! - 부정  var3은 var4보다 크지 않다.???
