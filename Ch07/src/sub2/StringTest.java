...
public class StringTest {
	public static void main(String[] args) {
		...
		//문자열 비교   (str1 == str2 이런식으로 하면 안됨. String은 주소값을 참조하기 때문)**********************************
		if(str1 == str2) {
		...
		System.out.println("msg 6번째 문자 : "+ msg.charAt(6));
		
		
		// 문자열 자르기
		String sub1 = msg.substring(0, 5);			//0부터 5까지 잘라라
		String sub2 = msg.substring(6);				//6부터 끝까지 잘라라
		...
		// 문자열 인덱스
		int idx1 = msg.indexOf("e");				//앞에서부터 찾기
		...
		String s1 = String.valueOf(var1);			//클래스 메서드, 정적 메서드, static
